package com.springframeworkguru.springframeworkgurumsscbrewery.controller.v2;
...
public class BeerControllerV2 {
    ...
    public ResponseEntity handlePost(@RequestBody BeerDtoV2 beerDtoV2){
        ...
        headers.add("Location","http://localhost:8090/api/v2/beer/"+savedDto.getId().toString());
